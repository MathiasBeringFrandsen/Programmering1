...
public class Controller {
    ...
    public static void addEmployeeToCompany(Employee employee, Company company) {
        company.addEmployee(employee);
        employee.setEmploymentYear(LocalDate.now().getYear());
    }
    ...
    public static Customer createCustomer(String name, int moneySpent, Company company){
        Customer customer = createCustomer(name);
        customer.setMoneySpent(moneySpent);
    ...
    public static void updateCustomer(Customer customer, String name, int moneySpent){
    ...
    public static void initStorage() {
        ...
        Controller.createCustomer("Morten", 2000, c1);
        Controller.createCustomer("Lasse", 4000, c1);
        Controller.createCustomer("Nikolaj", 300, c2);

        Controller.createCustomer("Anne");
    }
