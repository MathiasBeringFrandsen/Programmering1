...
public class ArrayApp {
    ...
    public static void main(String[] args) {
        ...
        int[] integers = {4, 6, 8, 2};
        System.out.println(metode.sum(integers));
        double[] doubles = {4.5, 6.3, 7.7, 2.6, 3.8};
        System.out.println(metode.sumDouble(doubles));
        int [] integers2 = {1, 3, 6, 7, 6};
        System.out.println(Arrays.toString(metode.makeSum(integers, integers2)));
        System.out.println(metode.hasUneven(integers));
        System.out.println(metode.hasUneven(integers2));
        System.out.println(metode.nextHighest(tabel2));
