...
public class StudentGui extends Application {
    ...
    private final Button btnfodselsdag = new Button("Fødselsdag");
    ...
    private void initContent(GridPane pane) {
        ...
        pane.add(btnfodselsdag, 4, 2);
        btnfodselsdag.setDisable(true);
        ...
        btnfodselsdag.setOnAction(event -> studerende.increaseAge());

    }

    private void addAction() {
        if (studerende == null) {
            studerende = new Student(txfName.getText().trim(), Integer.parseInt(txfAlder.getText().trim()), chkActive.isSelected());
            clearFields();
            txAInf.setText(getDescription());
            btnGet.setDisable(false);
            btnAdd.setDisable(true);
            btnfodselsdag.setDisable(false);
        }
    ...
    private void saveAction() {
        if (studerende != null) {
            ...
            studerende.setAge(Integer.parseInt(txfAlder.getText().trim()));
    ...
    private void getAction() {
        if (studerende != null) {
            ...
            txAInf.setText(getDescription());
            txfAlder.setText(studerende.getAge() + "");
